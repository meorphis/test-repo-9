...
import * as CardsAPI from '@stainless-temp/meorphis-test/resources/cards/cards';
import * as FinancialTransactionsAPI from '@stainless-temp/meorphis-test/resources/cards/financial-transactions';
