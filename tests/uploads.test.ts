import fs from 'fs';
import type { ResponseLike } from 'incident-io-2/internal/to-file';
import { toFile } from 'incident-io-2/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('incident-io-2/core/uploads');
    await expect(
