...
class TestMeorphisTest7:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "meorphis_test_7/_legacy_response.py",
                        "meorphis_test_7/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "meorphis_test_7/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeorphisTest7Error):
            client2 = MeorphisTest7(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
...
class TestAsyncMeorphisTest7:
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(MeorphisTest7Error):
            client2 = AsyncMeorphisTest7(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
