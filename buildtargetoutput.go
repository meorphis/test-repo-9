...
const (
	...
	BuildTargetOutputGetResponseObjectTypeOpenAPIWithTransforms  BuildTargetOutputGetResponseObjectType = "openapi-with-transforms"
	BuildTargetOutputGetResponseObjectTypeOpenAPIWithCodeSamples BuildTargetOutputGetResponseObjectType = "openapi-with-code-samples"
	BuildTargetOutputGetResponseObjectTypeOpenAPISDKSpec         BuildTargetOutputGetResponseObjectType = "openapi-sdk-spec"
)
