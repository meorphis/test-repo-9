...
// interacting with the eric-staging-co-5 API. You should not instantiate this
...
// DefaultClientOptions read from the environment (ERIC_STAGING_CO_5_API_KEY,
// ERIC_STAGING_CO_5_BASE_URL). This should be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("ERIC_STAGING_CO_5_BASE_URL"); ok {
		defaults = append(defaults, option.WithBaseURL(o))
	}
	if o, ok := os.LookupEnv("ERIC_STAGING_CO_5_API_KEY"); ok {
...
// environment (ERIC_STAGING_CO_5_API_KEY, ERIC_STAGING_CO_5_BASE_URL). The option
