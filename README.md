...
<a href="https://pkg.go.dev/github.com/meorphis/test-repo-9"><img src="https://pkg.go.dev/badge/github.com/meorphis/test-repo-9.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/meorphis/test-repo-9" // imported as ericstagingco5
)
```
...
```sh
go get -u 'github.com/meorphis/test-repo-9@v0.1.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/meorphis/test-repo-9/option).
