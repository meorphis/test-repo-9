...
export { ClientOptions } from 'incident-io-2';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/incident-io-2',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the incident-io-2 MCP server. You will use Code Mode to help the user perform
