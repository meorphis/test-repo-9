  ...
  inputSchema: {
    ...
    properties: {
      ...
      resource: {
        ...
        required: ['external_id', 'resource_type'],
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
...
export const handler = async (client: IncidentIo2, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.incidentAttachments.create(body)));
  } catch (error) {
