...
export const tool: Tool = {
  name: 'retrieve_openapi_v3_json',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nGet the OpenAPI (v3) definition.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/openapi_v3_json_retrieve_response',\n  $defs: {\n    openapi_v3_json_retrieve_response: {\n      type: 'string'\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      jq_filter: {
...
export const handler = async (client: IncidentIo2, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.openAPIV3Json.retrieve()));
  } catch (error) {
