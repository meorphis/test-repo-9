...
const prompt = `Runs JavaScript code to interact with the Incident Io 3 API.
...
const remoteStainlessHandler = async ({
  ...
  const localClientEnvs = {
    ...
    INCIDENT_IO_3_BASE_URL: readEnv('INCIDENT_IO_3_BASE_URL') ?? client.baseURL ?? undefined,
  };
